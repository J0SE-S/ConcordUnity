...
namespace Dissonance.Networking
{
        ...
        where TClient : BaseClient<TServer, TClient, TPeer>
    {
        ...
        [NotNull] internal TrafficCounter RecvRemoveClient => _recvRemoveClient;
        private readonly TrafficCounter _recvVoiceData = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvVoiceData => _recvVoiceData;
        private readonly TrafficCounter _recvTextData = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvTextData => _recvTextData;
        private readonly TrafficCounter _recvHandshakeResponse = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvHandshakeResponse => _recvHandshakeResponse;
        private readonly TrafficCounter _recvHandshakeP2P = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvHandshakeP2P => _recvHandshakeP2P;
        private readonly TrafficCounter _recvClientState = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvClientState => _recvClientState;
        private readonly TrafficCounter _recvDeltaState = new TrafficCounter();
        [NotNull] internal TrafficCounter RecvDeltaState => _recvDeltaState;
        private readonly TrafficCounter _sentServer = new TrafficCounter();
        [NotNull] internal TrafficCounter SentServerTraffic => _sentServer;
